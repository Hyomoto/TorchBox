"""
This is the global memory module for the Sock & Sorcery game.
It provides shared values that can be accessed and modified by all scenes and
...
class Taggable:
    ...
    def __init__(self, tags: Set[str] = None, **kwargs):
